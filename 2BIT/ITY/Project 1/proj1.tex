...
\author{Matúš Fignár\\ \href{mailto:xfignam00@fit.vut.cz}{xfignam00@fit.vutbr.cz}}
\date{}
...
\begin{quotation}
    Čím více \textsc{druhů}, \emph{řezů}, {\scriptsize velikostí}, \textcolor{green}{barev} písma a~jiných \texttt{efektů} použijeme, 
    \underline{tím profesionálněji} bude {\fontfamily{pzc}\selectfont dokument} vypadat.
    Čtenář tím bude \textbf{\LARGE{vždy nadšen!}}
\end{quotation}
\par
\textsc{Tímto pravidlem se nesmíte \textbf{\underline{nikdy} řídit.}}
Příliš časté zvýrazňování textových elementů a~změny {\tiny velikosti} písma jsou známkou amatérismu autora a~působí \texttt{velmi rušivě}.
...
pouze pro klíčová slova, \emph{kurzíva} pouze pro doposud neznámé pojmy a~nebude se to míchat.
...
Olšáka\footnote{Viz \href{http://petr.olsak.net/ftp/olsak/vlna/}{\texttt{http://petr.olsak.net/ftp/olsak/vlna/}}}, který je vhodné si v~rámci projektu vyzkoušet.
\par
